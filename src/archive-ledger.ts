...
export function ensureArchiveLedger(db: Database.Database): void {
  db.exec(`
...
export function putArchiveObject(db: Database.Database, record: ArchiveObjectRecord): void {
  db.prepare(`
...
export function getArchiveObject(db: Database.Database, identity: string): ArchiveObjectRecord | null {
